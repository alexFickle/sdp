...
//Alex Fickle did this
// not dealing with mask registers here
#define GPIO3DATA		REGISTER_32(GPIO3_BASE + 0x3ffc)
#define GPIO3DIR		REGISTER_32(GPIO3_BASE + 0x8000)
#define GPIO3IS			REGISTER_32(GPIO3_BASE + 0x8004)
#define GPIO3IBE		REGISTER_32(GPIO3_BASE + 0x8008)
#define GPIO3IEV		REGISTER_32(GPIO3_BASE + 0x800c)
#define GPIO3IE			REGISTER_32(GPIO3_BASE + 0x8010)
#define GPIO3RIS		REGISTER_32(GPIO3_BASE + 0x8014)
#define GPIO3MIS		REGISTER_32(GPIO3_BASE + 0x8018)
#define GPIO3IC			REGISTER_32(GPIO3_BASE + 0x801c)
